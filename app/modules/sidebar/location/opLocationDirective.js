angular.module('opApp')
    .directive('opLocation', function ($filter, opCoordinateConversionService, opStateService) {
        'use strict';
        return {
                ...
                scope.setLocationCountry = function () {
                    ...
                    if (scope.country) {
                        ...
                        if(scope.country.name === 'USA') {
                            opStateService.setAttributeBBoxCountry(scope.model.usaGeo);
                        } else if (scope.country.name === 'Canada') {
                            opStateService.setAttributeBBoxCountry(scope.model.canadaGeo);
                        }
                    }
                };
